...
public class MongoDBProcessor {
	public void mongoDBConnection(LettersDTO lettersDTO) {
		...
		try (var mongoClient = MongoClients.create()){
		    ...
		    var todoDocument = new Document(Map.of("_id", new ObjectId(), "Line", lettersDTO.getReadedLine(), "Type of input", lettersDTO.getTypeOfInput()
		    		, "Vowels", lettersDTO.getVowelsCountInLine(), "Consonants", lettersDTO.getConsonantsCountInLine(), "Date of create", lettersDTO.getTimestamp()));
